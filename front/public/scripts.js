...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('login-form').addEventListener('submit', (e) => {
        ...
        fetch('${process.env.REACT_APP_BACKEND_URL}:5000/api/user/login', {
            method: 'POST',
    ...
    document.getElementById('signup-form').addEventListener('submit', (e) => {
        ...
        fetch('${process.env.REACT_APP_BACKEND_URL}:5000/api/user/signup', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    // 로그인 상태 확인 후 닉네임 출력
    if (token) {
        fetch('${process.env.REACT_APP_BACKEND_URL}:5000/api/user/profile', {
    ...
    document.getElementById('favorites-btn').addEventListener('click', () => {
        fetch('${process.env.REACT_APP_BACKEND_URL}:5000/api/movies/favorites', {
            headers: { Authorization: `Bearer ${token}` }
        })
        .then(res => res.json())
        .then(movies => {
